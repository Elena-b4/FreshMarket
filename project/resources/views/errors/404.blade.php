        ...
        <div class="container-fluid padding-0">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 page-left">
                    <div class="image">
                        <img class="img-responsive" src="{{ asset('img/404-left.png') }}" alt="Image 404">
                    </div>
                    ...
                    <a class="btn btn-primary" href="{{ route('products.index') }}"><i class="fa fa-home" aria-hidden="true"></i><span>Back to homepage</span></a>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 page-right">
                    <div class="image">
                        <img class="img-responsive" src="{{ asset('img/404-right.jpg') }}" alt="Image 404">
                    </div>
                </div>
            </div>
        </div>
